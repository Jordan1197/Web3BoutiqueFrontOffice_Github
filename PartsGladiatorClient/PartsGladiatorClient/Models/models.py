...
class AuthenCustomuser(models.Model):
    ...
    addressid = models.IntegerField(
        db_column='AddressId', blank=True, null=True)
    # Field name made lowercase.
...
class Cartproduct(models.Model):
    # Field name made lowercase.
    cartid = models.OneToOneField(
        'PgCart', models.DO_NOTHING, db_column='CartId', primary_key=True)
    # Field name made lowercase.
    productid = models.ForeignKey(
        'PgProduct', models.DO_NOTHING, db_column='ProductId')
...
class PaypalIpn(models.Model):
    ...
    notify_version = models.DecimalField(
        max_digits=64, decimal_places=2, blank=True, null=True)
    ...
    exchange_rate = models.DecimalField(
        max_digits=64, decimal_places=16, blank=True, null=True)
...
class PgAddress(models.Model):
    ...
    # Field name made lowercase.
    zipcode = models.TextField(db_column='ZipCode', blank=True, null=True)
    # Field name made lowercase.
...
class PgAdmin(models.Model):
    ...
    # Field name made lowercase.
    activationcode = models.CharField(
        db_column='ActivationCode', max_length=36, db_collation='ascii_general_ci')
    # Field name made lowercase.
...
class PgCategory(models.Model):
    ...
    description = models.TextField(db_column='Description')
    # Field name made lowercase.
    imagepath = models.TextField(db_column='ImagePath', blank=True, null=True)
    # Field name made lowercase.
    createddate = models.DateTimeField(db_column='CreatedDate')
    # Field name made lowercase.
    createdby = models.TextField(db_column='CreatedBy', blank=True, null=True)
...
class PgProduct(models.Model):
    ...
    # Field name made lowercase.
    attributid = models.IntegerField(db_column='AttributId')
    # Field name made lowercase.
    caracteristicid = models.IntegerField(db_column='CaracteristicId')
    # Field name made lowercase.
    retailerid = models.IntegerField(db_column='RetailerId')
    # Field name made lowercase.
    promotionid = models.IntegerField(
        db_column='PromotionId', blank=True, null=True)
    # Field name made lowercase.
    createddate = models.DateTimeField(db_column='CreatedDate')
    # Field name made lowercase.
    createdby = models.TextField(db_column='CreatedBy', blank=True, null=True)
...
class PgTransaction(models.Model):
    ...
    id = models.AutoField(db_column='Id', primary_key=True)
    # Field name made lowercase.
    paypalid = models.TextField(db_column='PaypalId', blank=True, null=True)
    # Field name made lowercase.
    currentstate = models.TextField(
        db_column='CurrentState', blank=True, null=True)
    # Field name made lowercase.
    paymentmethod = models.TextField(
        db_column='PaymentMethod', blank=True, null=True)
    # Field name made lowercase.
    clientid = models.IntegerField(db_column='ClientId')
    # Field name made lowercase.
    carrierid = models.IntegerField(db_column='CarrierId')
    # Field name made lowercase.
    createddate = models.DateTimeField(db_column='CreatedDate')
    # Field name made lowercase.
    createdby = models.TextField(db_column='CreatedBy', blank=True, null=True)
...
class PgTransactionproduct(models.Model):
    ...
    # Field name made lowercase.
    productid = models.ForeignKey(
        PgProduct, models.DO_NOTHING, db_column='ProductId', blank=True, null=True)
    # Field name made lowercase.
    transactionid = models.IntegerField(db_column='TransactionId')
    price = models.FloatField(db_column='Price')  # Field name made lowercase.
    # Field name made lowercase.
    reduction = models.FloatField(db_column='Reduction')
    # Field name made lowercase.
    createddate = models.DateTimeField(db_column='CreatedDate')
    # Field name made lowercase.
    createdby = models.TextField(db_column='CreatedBy', blank=True, null=True)
...
class PgTypeattribut(models.Model):
    ...
    id = models.AutoField(db_column='Id', primary_key=True)
    # Field name made lowercase.
    attribut = models.TextField(db_column='Attribut', blank=True, null=True)
    # Field name made lowercase.
    createddate = models.DateTimeField(db_column='CreatedDate')
    # Field name made lowercase.
    createdby = models.TextField(db_column='CreatedBy', blank=True, null=True)
...
class PgValeurattribut(models.Model):
    ...
    typeid = models.ForeignKey(
        PgTypeattribut, models.DO_NOTHING, db_column='TypeId', blank=True, null=True)
    # Field name made lowercase.
    createddate = models.DateTimeField(db_column='CreatedDate')
    # Field name made lowercase.
    createdby = models.TextField(db_column='CreatedBy', blank=True, null=True)
...
class PgValeurcharacteristic(models.Model):
    ...
    name = models.TextField(db_column='Name', blank=True, null=True)
    # Field name made lowercase.
    typecharacteristicid = models.ForeignKey(
        PgCharacteristic, models.DO_NOTHING, db_column='TypeCharacteristicId', blank=True, null=True)
    # Field name made lowercase.
    createddate = models.DateTimeField(db_column='CreatedDate')
    # Field name made lowercase.
    createdby = models.TextField(db_column='CreatedBy', blank=True, null=True)
